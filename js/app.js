...
const cardOriginalMarvel = document.getElementById('ContHeroCardMarvel')
const contTarjetasMarvel = document.getElementById('ContTarjetasMarvel')
...
HeroesMarvel.forEach(hero => {
    ...
    let clon = clonar(cardOriginalMarvel)

    clon.querySelector('#TxtTituloMarvel').innerHTML = hero.name
